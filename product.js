   ...
   f.append('category',(ca?ca.value:(e('default_category').value?e('default_category').value:'auto')));
...
function getFieldFetch(name_){
 ...
 return '<a href=# onclick="saveProduct_3(e(\'link_'+ind+'\'),'+fff+');return false;" >'+name_+'</a><br>';
  ...
  return '<a href=# onclick="saveArticle();return false;" >'+name_+'</a><br>';
 //return '<a href=# onclick="saveArticle_2(e(\'link_'+ind+'\'),'+ind+');return false;" >'+name_+'</a><br>';    
		    }
}
